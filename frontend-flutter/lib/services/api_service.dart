...
class ApiService {
  ...
  static Future<void> confirmarPagamento(int pessoaId, String mes) async {
    await http.post(
  ...
  static Future<List<Pagamento>> getPagamentos(String mes) async {
    final response = await http.get(Uri.parse('$baseUrl/pagamento/$mes'));
    final List jsonData = json.decode(response.body);
